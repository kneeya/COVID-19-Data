        ...
        {this.state.loaded && this.state.ready ? (
          <React.Fragment>
            ...
            <div className="ontario-row">
              ...
              <div className="item item-7" title={trans.agebreak.title[lang]}>
              ...
              <div className="item item-1">
                <ItemWrapper title={trans.positive.title[lang]}>
                  {accessible ? (
                    <div>Future Table</div>
                  ) : (
              ...
              <div className="item item-3">
                <ItemWrapper title={trans.deaths.title[lang]}>
                  {accessible ? (
                    <div>Future Table</div>
                  ) : (
                    <Recovered
                      data={this.state.data}
                      title={trans.resolved.title[lang]}
                    />
                  )}
                </ItemWrapper>
              </div>

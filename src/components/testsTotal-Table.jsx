...
class StackedTable extends React.Component {
  ...
  render() {
    let tableData = [...covidData.result.records]
      .filter((item) => item[dict.patientsApprovedTestingasofDate])
      .map((item, z) => {
        ...
        return {
          ...
          totalTest:
            ...
            item[dict.patientsApprovedTestingasofDate].toLocaleString(),
        };
      });
    ...
    const columns = [
      ...
      {
        title: trans.testing.totalTesting[this.props.lang],
        dataIndex: "totalTest",
        key: "totalTest",
        width: "20%",
